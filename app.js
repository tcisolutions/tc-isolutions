...
from "./js/order/NewOrderWizard.js";
...
} from "./js/components/dashboard/index.js";
...
function bind() {
  ...
  const sectionsContainer =
    document.querySelector(".nx-orders-sections");
...
async function home() {
  ...
  console.log("🔥 NUEVO DASHBOARD NEXUS EJECUTÁNDOSE");
    ...
    $("#content").innerHTML = `
        ...
        <div class="nx-dashboard">
            ...
            <section class="nx-dashboard-panels">
                ...
                <article
                    class="nx-dashboard-panel">

                    <div
                        class="nx-dashboard-panel-header">

                        <div>

                            <span
                                class="nx-dashboard-panel-eyebrow">
                    ...
                    <div
                        class="nx-status-list">


                        <div
                            class="nx-status-item">

                            <span>

                                <i
                                    class="nx-status-dot nx-dot-blue">
                                </i>
                        ...
                        <div
                            ...
                            <span>
                                ...
                                <i
                                    class="nx-status-dot nx-dot-yellow">
                                </i>
                        ...
                        <div
                            ...
                            <span>
                                ...
                                <i
                                    class="nx-status-dot nx-dot-orange">
                                </i>
                        ...
                        <div
                            ...
                            <span>
                                ...
                                <i
                                    class="nx-status-dot nx-dot-purple">
                                </i>
                        ...
                        <div
                            ...
                            <span>
                                ...
                                <i
                                    class="nx-status-dot nx-dot-green">
                                </i>
                        ...
                        <div
                            ...
                            <span>
                                ...
                                <i
                                    class="nx-status-dot nx-dot-gray">
                                </i>
                ...
                <article
                    class="nx-dashboard-panel nx-dashboard-recent">
                        ...
                        ${
                            ...
                            orders
                                ...
                                .map(order => `
                                    ...
                                    <div
                                        class="nx-recent-order">

                                        <div
                                            class="nx-recent-order-main">
                ...
                <article
                    class="nx-dashboard-panel nx-dashboard-revenue">
                    ...
                    <div
                        class="nx-revenue-placeholder">

                        <div
                            class="nx-revenue-line">
                    ...
                    <div
                        class="nx-revenue-footer">

                        <span>

                            Los ingresos reales se
                            conectarán con Caja.
...
$("#newOrder").onclick =
    () => {
        ...
        if (!container) {
            ...
            console.error(
                "No se encontró el contenedor del Wizard."
            );
        ...
        createNewOrderWizard(
...

            {
                ...
                async onFinish(
                    ...
                    console.log(
                        "🔥 CONTEXTO FINAL NUEVA ORDEN:",
                        context
                    );


                    alert(
                        "El Wizard terminó correctamente. Todavía no se ha guardado la orden."
                    );
